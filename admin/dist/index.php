        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          ...
          <div>
            <a class="navbar-brand brand-logo" href="index.php">
              <img src="assets/images/logothuvien.png" alt="Thư viện Trường Học" style="height:50px; width:auto; margin-right:10px;">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown d-none d-lg-block">
              <a class="nav-link dropdown-bordered dropdown-toggle dropdown-toggle-split" id="messageDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false"> Chọn danh mục </a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                <a class="dropdown-item py-3">
                  <p class="mb-0 fw-medium float-start">Chọn danh mục</p>
                </a>
            ...
            <!-- <li class="nav-item dropdown d-none d-lg-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="mb-1 mt-3 fw-semibold">Binh</p>
                  <p class="fw-light text-muted mb-0">binhtt602@gmail.com</p>
                </div>
                <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i>
 Trang Cá Nhân <span class="badge badge-pill badge-danger">1</span></a>
                <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-message-text-outline text-primary me-2"></i> Nhắn Tin</a>
...
<li class="nav-item">
  <a class="nav-link" href="index.php?page_layout=danhsachloaisach">
    ...
    <span class="menu-title">Thể Loại Sách</span>
            ...
            <li class="nav-item">
  <a class="nav-link" href="index.php?page_layout=danhsachsach">
  ...
  <li class="nav-item">
  <a class="nav-link" href="index.php?page_layout=danhsachmuonsach">
    <i class="menu-icon mdi mdi-book-open-page-variant"></i>
    <span class="menu-title">Mượn Sách</span>
  </a>
</li>
           ...
           <li class="nav-item">
  <a class="nav-link" href="index.php?page_layout=danhsachtacgia">
    ...
    <span class="menu-title">Tác Giả</span>
           ...
           <li class="nav-item">
  <a class="nav-link" href="index.php?page_layout=danhsachnguoidung">
